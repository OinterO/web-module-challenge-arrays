...
function getFlavorByIndex(originalFlavors){
   ...
   let result = originalFlavors.find(getFlavorByIndex(originalFlavors,2));
...
originalFlavors.splice(0, 1, 'vanilla');
...
function copy(origA, newA){

origA = [...newA];
return newA;
}
console.log(origA, originalFlavors)
